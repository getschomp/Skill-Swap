...
feature " User fills in main form on homepage ", %q{
  ...
  scenario "User fills out both select boxes and there are other users that meet their criteria" do
    visit_path landing_path
    #build new skill1
    #build new skill2
    #build new user
    #fill_in To Learn with: Japanesse
    #fill_in To Learn with: Ruby
    #will redirect to signup
    #expect page to have content showing flash notice showing number of users with that skill
    #expect page to have content username
