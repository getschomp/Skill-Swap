...
feature " User fills in main form on homepage ", %q{
  ...
  - [ ] expect the page to ask a diffrent message it they are the first user that matches the combination
  ...
  - [ ] if the skills are not in the database expecect the page to propmt the user to sign up for an account
    and add the skill
    ...
    #happy path!
    scenario "User fills out both select boxes snd decides to create an account"
